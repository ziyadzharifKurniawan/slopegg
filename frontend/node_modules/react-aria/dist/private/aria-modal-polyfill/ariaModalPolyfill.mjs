import {hideOthers as $03QC9$hideOthers} from "aria-hidden";
 ...
 */ 
const $200419fd6cc32a88$var$currentDocument = typeof document !== 'undefined' ? document : undefined;
function $200419fd6cc32a88$export$11dddb85aae73809(selector = 'body', { document: document1 = $200419fd6cc32a88$var$currentDocument } = {}) {
    /**
        ...
        for (let mutation of mutationRecord){
            if (mutation.type === 'childList' && mutation.addedNodes.length > 0) {
                ...
                if (addNode) {
                    ...
                    undo = (0, $03QC9$hideOthers)(others);
                }
...
export {$200419fd6cc32a88$export$11dddb85aae73809 as watchModals};
//# sourceMappingURL=ariaModalPolyfill.mjs.map

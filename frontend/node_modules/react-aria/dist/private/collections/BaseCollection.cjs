...
$parcel$export(module.exports, "CollectionNode", function () { return $a76f1c7ecd25aae2$export$d68d59712b04d9d1; });
$parcel$export(module.exports, "FilterableNode", function () { return $a76f1c7ecd25aae2$export$b1918e978f1ee46f; });
$parcel$export(module.exports, "HeaderNode", function () { return $a76f1c7ecd25aae2$export$5ae2504e948afce5; });
$parcel$export(module.exports, "LoaderNode", function () { return $a76f1c7ecd25aae2$export$8258a0665a675899; });
$parcel$export(module.exports, "ItemNode", function () { return $a76f1c7ecd25aae2$export$fd11f34e1d07f134; });
$parcel$export(module.exports, "SectionNode", function () { return $a76f1c7ecd25aae2$export$437f11dc9b403b78; });
$parcel$export(module.exports, "BaseCollection", function () { return $a76f1c7ecd25aae2$export$408d25a4e12db025; });
/*
 ...
 */ class $a76f1c7ecd25aae2$export$d68d59712b04d9d1 {
    constructor(key){
        this.value = null;
        this.level = 0;
...
class $a76f1c7ecd25aae2$export$b1918e978f1ee46f extends $a76f1c7ecd25aae2$export$d68d59712b04d9d1 {
    filter(collection, newCollection, filterFn) {
        let [firstKey, lastKey] = $a76f1c7ecd25aae2$var$filterChildren(collection, newCollection, this.firstChildKey, filterFn);
...
class $a76f1c7ecd25aae2$export$5ae2504e948afce5 extends $a76f1c7ecd25aae2$export$d68d59712b04d9d1 {
    static{
        this.type = 'header';
    }
}
class $a76f1c7ecd25aae2$export$8258a0665a675899 extends $a76f1c7ecd25aae2$export$d68d59712b04d9d1 {
    static{
        this.type = 'loader';
    }
}
class $a76f1c7ecd25aae2$export$fd11f34e1d07f134 extends $a76f1c7ecd25aae2$export$b1918e978f1ee46f {
    static{
        this.type = 'item';
    }
    filter(collection, newCollection, filterFn) {
...
class $a76f1c7ecd25aae2$export$437f11dc9b403b78 extends $a76f1c7ecd25aae2$export$b1918e978f1ee46f {
    static{
        this.type = 'section';
    }
    filter(collection, newCollection, filterFn) {
...
class $a76f1c7ecd25aae2$export$408d25a4e12db025 {
    get size() {
    ...
    *[Symbol.iterator]() {
    ...
    filter(filterFn) {
        ...
        let [firstKey, lastKey] = $a76f1c7ecd25aae2$var$filterChildren(this, newCollection, this.firstKey, filterFn);
...
function $a76f1c7ecd25aae2$var$filterChildren(collection, newCollection, firstChildKey, filterFn) {
...
//# sourceMappingURL=BaseCollection.cjs.map

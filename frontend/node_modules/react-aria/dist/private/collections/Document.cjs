...
$parcel$export(module.exports, "Document", function () { return $d25e7dd485e8c002$export$b34a105447964f9f; });
/*
 ...
 */ class $d25e7dd485e8c002$export$410b0c854570d131 {
...
class $d25e7dd485e8c002$export$dc064fe9e59310fd extends $d25e7dd485e8c002$export$410b0c854570d131 {
    ...
    get level() {
        if (this.parentNode instanceof $d25e7dd485e8c002$export$dc064fe9e59310fd) return this.parentNode.level + (this.parentNode.node?.type === 'item' ? 1 : 0);
        return 0;
    }
    /**
   ...
   */ getMutableNode() {
    ...
    updateNode() {
        ...
        node.parentKey = this.parentNode instanceof $d25e7dd485e8c002$export$dc064fe9e59310fd ? this.parentNode.node?.key ?? null : null;
...
class $d25e7dd485e8c002$export$b34a105447964f9f extends $d25e7dd485e8c002$export$410b0c854570d131 {
    ...
    createElement(type) {
        return new $d25e7dd485e8c002$export$dc064fe9e59310fd(type, this);
    }
    ...
    updateCollection() {
        ...
        for (let element of this.dirtyNodes)if (element instanceof $d25e7dd485e8c002$export$dc064fe9e59310fd && (!element.isConnected || element.isHidden)) this.removeNode(element);
        else element.updateChildIndices();
        // Next, update dirty collection nodes.
        for (let element of this.dirtyNodes)if (element instanceof $d25e7dd485e8c002$export$dc064fe9e59310fd) {

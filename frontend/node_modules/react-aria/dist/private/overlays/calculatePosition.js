...
function $ba2991ee81d3897a$export$b3ceb0cbf1056d98(opts) {
    ...
    let childOffset = isViewportContainer ? $ba2991ee81d3897a$var$getOffset(targetNode, false) : $ba2991ee81d3897a$var$getPosition(targetNode, container, false);
...
function $ba2991ee81d3897a$var$getOffset(node, ignoreScale) {
    let { top: top, left: left, width: width, height: height } = $ba2991ee81d3897a$export$4b834cebd9e5cebe(node, ignoreScale);
...
function $ba2991ee81d3897a$var$getPosition(node, parent, ignoreScale) {
    let style = window.getComputedStyle(node);
    let offset;
    if (style.position === 'fixed') offset = $ba2991ee81d3897a$export$4b834cebd9e5cebe(node, ignoreScale);
    else {
        offset = $ba2991ee81d3897a$var$getOffset(node, ignoreScale);

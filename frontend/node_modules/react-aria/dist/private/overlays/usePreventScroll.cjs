...
function $b5daf4744c764686$export$ee0f7cc6afcd1c18(options = {}) {
    ...
    (0, $429333cab433657c$exports.useLayoutEffect)(()=>{
        ...
        if ($b5daf4744c764686$var$preventScrollCount === 1) {
            if ((0, $d0b4a781cf26e80b$exports.isIOS)()) $b5daf4744c764686$var$restore = $b5daf4744c764686$var$preventScrollMobileSafari();
...
function $b5daf4744c764686$var$preventScrollStandard() {
    ...
    ('scrollbarGutter' in document.documentElement.style ? $b5daf4744c764686$var$setStyle(document.documentElement, 'scrollbarGutter', 'stable') : $b5daf4744c764686$var$setStyle(document.documentElement, 'paddingRight', `${scrollbarWidth}px`)), $b5daf4744c764686$var$setStyle(document.documentElement, 'overflow', 'hidden'));
}
...
function $b5daf4744c764686$var$preventScrollMobileSafari() {
    ...
    let restoreOverflow = $b5daf4744c764686$var$setStyle(document.documentElement, 'overflow', 'hidden');
    let scrollable;
...
@layer {
  * {
    ...
    let removeEvents = (0, $2f95486cfdaa743c$exports.chain)($b5daf4744c764686$var$addEvent(document, 'touchstart', onTouchStart, {
        passive: false,
        capture: true
    }), $b5daf4744c764686$var$addEvent(document, 'touchmove', onTouchMove, {
        passive: false,
        capture: true
    }), $b5daf4744c764686$var$addEvent(document, 'blur', onBlur, true));
    return ()=>{
        restoreOverflow();
        removeEvents();
        style.remove();
...
function $b5daf4744c764686$var$setStyle(element, style, value) {

import {GridKeyboardDelegate as $bd737065d28db63c$export$de9feff04fda126e} from "../grid/GridKeyboardDelegate.js";
import {getFirstItem as $8Dg1S$getFirstItem, getChildNodes as $8Dg1S$getChildNodes} from "react-stately/private/collections/getChildNodes";
...
class $a2b612fa9883d53c$export$da43f8f5cb04028d extends (0, $bd737065d28db63c$export$de9feff04fda126e) {
    isCell(node) {
    ...
    getKeyBelow(key) {
        ...
        if (startItem.type === 'column') {
            let child = (0, $8Dg1S$getFirstItem)((0, $8Dg1S$getChildNodes)(startItem, this.collection));
    ...
    findNextColumnKey(column) {
        ...
        for (let item of (0, $8Dg1S$getChildNodes)(row, this.collection)){
    ...
    findPreviousColumnKey(column) {
        ...
        let row = this.collection.headerRows[column.level];
        let childNodes = [
            ...(0, $8Dg1S$getChildNodes)(row, this.collection)
        ];
    ...
    getKeyForSearch(search, fromKey) {
        ...
        while(key != null){
            ...
            for (let cell of (0, $8Dg1S$getChildNodes)(item, this.collection)){
...
export {$a2b612fa9883d53c$export$da43f8f5cb04028d as TableKeyboardDelegate};
//# sourceMappingURL=TableKeyboardDelegate.js.map

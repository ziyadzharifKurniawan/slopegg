import {useTextField as $032ede929f47bd98$export$712718f7aec83d5} from "./useTextField.js";
...
import {useEffect as $1gi5y$useEffect, useRef as $1gi5y$useRef} from "react";
...
function $a97100a6dd40f368$var$supportsNativeBeforeInputEvent() {
    return typeof window !== 'undefined' && window.InputEvent && typeof InputEvent.prototype.getTargetRanges === 'function';
}
function $a97100a6dd40f368$export$4f384c9210e583c3(props, state, inputRef) {
    ...
    let onBeforeInputFallback = (0, $85567ef950781b7d$export$7f54fc3180508a52)((e)=>{
    ...
    (0, $1gi5y$useEffect)(()=>{
        if (!$a97100a6dd40f368$var$supportsNativeBeforeInputEvent() || !inputRef.current) return;
        let input = inputRef.current;
    ...
    let onBeforeInput = !$a97100a6dd40f368$var$supportsNativeBeforeInputEvent() ? (e)=>{
        let nextValue = (0, $d8ac7ed472840322$export$e58f029f0fbfdb29)(e).value.slice(0, (0, $d8ac7ed472840322$export$e58f029f0fbfdb29)(e).selectionStart) + e.data + (0, $d8ac7ed472840322$export$e58f029f0fbfdb29)(e).value.slice((0, $d8ac7ed472840322$export$e58f029f0fbfdb29)(e).selectionEnd);
...
export {$a97100a6dd40f368$export$4f384c9210e583c3 as useFormattedTextField};
//# sourceMappingURL=useFormattedTextField.js.map

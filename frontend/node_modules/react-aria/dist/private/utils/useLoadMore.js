import {useEvent as $c3cab330536504ec$export$90fc3a17d93f704c} from "./useEvent.js";
import {useLayoutEffect as $53fed047b798be36$export$e5c5a5f917a5871c} from "./useLayoutEffect.js";
import {useRef as $cmieS$useRef, useCallback as $cmieS$useCallback} from "react";
...
function $cd2e8e7876581394$export$7717c92ee915373e(props, ref) {
    let { isLoading: isLoading, onLoadMore: onLoadMore, scrollOffset: scrollOffset = 1, items: items } = props;
    // Handle scrolling, and call onLoadMore when nearing the bottom.
    let isLoadingRef = (0, $cmieS$useRef)(isLoading);
    let prevProps = (0, $cmieS$useRef)(props);
    let onScroll = (0, $cmieS$useCallback)(()=>{
    ...
    let lastItems = (0, $cmieS$useRef)(items);
    ...
    (0, $c3cab330536504ec$export$90fc3a17d93f704c)(ref, 'scroll', onScroll);
}


export {$cd2e8e7876581394$export$7717c92ee915373e as useLoadMore};

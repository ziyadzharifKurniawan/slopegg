import {useState as $l7jaK$useState} from "react";
 ...
 */ 
function $fed32bb7b9c8a2e7$export$d14e1352e21f4a16(options) {
    ...
    return {
        ...
        moveBefore (key, keys) {
            setItems((prevState)=>{
                ...
                return $fed32bb7b9c8a2e7$var$moveItems(prevState, keys, parent, toIndex, updateTree, addNode);
            });
        },
        moveAfter (key, keys) {
            setItems((prevState)=>{
...
function $fed32bb7b9c8a2e7$var$moveItems(state, keys, toParent, toIndex, updateTree, addNode) {
...
export {$fed32bb7b9c8a2e7$export$d14e1352e21f4a16 as useTreeData};

import {useState as $fD7Vs$useState, useRef as $fD7Vs$useRef} from "react";
 ...
 */ 
function $17f1eecf4a5d8104$export$29efd034f1d79f81(props) {
    ...
    let [, setDragging] = (0, $fD7Vs$useState)(false);
    let draggingKeys = (0, $fD7Vs$useRef)(new Set());
    let draggedKey = (0, $fD7Vs$useRef)(null);
    let getKeys = (key)=>{
...
export {$17f1eecf4a5d8104$export$29efd034f1d79f81 as useDraggableCollectionState};
//# sourceMappingURL=useDraggableCollectionState.js.map

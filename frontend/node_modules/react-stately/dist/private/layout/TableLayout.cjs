...
var $d474db7fa4a60716$exports = require("./ListLayout.cjs");
var $2bdd626d0eea82c5$exports = require("../virtualizer/Rect.cjs");
var $f9c934dfa703bb0a$exports = require("../virtualizer/Size.cjs");
var $fe2d0e9e91841d18$exports = require("../table/TableColumnLayout.cjs");
...
$parcel$export(module.exports, "TableLayout", function () { return $779e19dedce4578d$export$62444c3c724b1b20; });
/*
...
const $779e19dedce4578d$var$DEFAULT_ROW_HEIGHT = 48;
class $779e19dedce4578d$export$62444c3c724b1b20 extends (0, $d474db7fa4a60716$exports.ListLayout) {
    constructor(options){
    ...
    update(invalidationContext) {
        ...
        if (invalidationContext.layoutOptions?.columnWidths) {
            ...
            let columnLayout = new (0, $fe2d0e9e91841d18$exports.TableColumnLayout)({});
    ...
    buildCollection() {
        ...
        this.contentSize = new (0, $f9c934dfa703bb0a$exports.Size)(body.layoutInfo.rect.width + this.padding * 2, body.layoutInfo.rect.maxY + this.padding);
        return [
            header,
            body
        ];
    ...
    buildTableHeader() {
        let collection = this.virtualizer.collection;
        let rect = new (0, $2bdd626d0eea82c5$exports.Rect)(this.padding, this.padding, 0, 0);
        let layoutInfo = new (0, $6114beb2608093a1$exports.LayoutInfo)('header', collection.head?.key ?? 'header', rect);
    ...
    buildHeaderRow(headerRow, x, y) {
        let rect = new (0, $2bdd626d0eea82c5$exports.Rect)(x, y, 0, 0);
        let row = new (0, $6114beb2608093a1$exports.LayoutInfo)('headerrow', headerRow.key, rect);
        let height = 0;
        let columns = [];
        for (let cell of (0, $c731fb93d14b07fc$exports.getChildNodes)(headerRow, this.virtualizer.collection)){
    ...
    getEstimatedHeight(node, width, height, estimatedHeight) {
        ...
        if (height == null) {
            ...
            if (previousLayoutNode) {
                ...
                height = estimatedHeight ?? $779e19dedce4578d$var$DEFAULT_ROW_HEIGHT;
                isEstimated = true;
            }
        }
        return {
    ...
    getEstimatedRowHeight() {
        return this.rowHeight ?? this.estimatedRowHeight ?? $779e19dedce4578d$var$DEFAULT_ROW_HEIGHT;
    }
    buildColumn(node, x, y) {
        ...
        let rect = new (0, $2bdd626d0eea82c5$exports.Rect)(x, y, width, height);
    ...
    buildBody(y) {
        let collection = this.virtualizer.collection;
        let rect = new (0, $2bdd626d0eea82c5$exports.Rect)(this.padding, y, 0, 0);
        let layoutInfo = new (0, $6114beb2608093a1$exports.LayoutInfo)('rowgroup', collection.body.key, rect);
        let startY = y;
        let skipped = 0;
        let width = 0;
        let children = [];
        let rowHeight = this.getEstimatedRowHeight() + this.gap;
        let childNodes = (0, $c731fb93d14b07fc$exports.getChildNodes)(collection.body, collection);
        for (let node of childNodes){
            ...
            if (y > this.requestedRect.maxY) {
                ...
                let lastNode = (0, $c731fb93d14b07fc$exports.getLastItem)(childNodes);
    ...
    buildRow(node, x, y) {
        let collection = this.virtualizer.collection;
        let rect = new (0, $2bdd626d0eea82c5$exports.Rect)(x, y, 0, 0);
        let layoutInfo = new (0, $6114beb2608093a1$exports.LayoutInfo)('row', node.key, rect);
        let children = [];
        let height = 0;
        for (let child of (0, $c731fb93d14b07fc$exports.getChildNodes)(node, collection))if (child.type === 'cell') {

import {getChildNodes as $684db7aaf37fc901$export$1005530eda016c13, getLastItem as $684db7aaf37fc901$export$7475b2c64539e4cf} from "../collections/getChildNodes.js";
...
class $3b3982063797be09$export$62444c3c724b1b20 extends (0, $f46b9da090161919$export$cacbb3924155d68e) {
    ...
    buildCollection() {
        ...
        this.contentSize = new (0, $266cbd2785be3a2c$export$cb6da89c6af1a8ec)(body.layoutInfo.rect.width + this.padding * 2, body.layoutInfo.rect.maxY + this.padding);
        return [
            header,
            body
        ];
    ...
    buildBody(y) {
        ...
        let layoutInfo = new (0, $dcdbc700dd92e06f$export$7e0eeb9da702a085)('rowgroup', collection.body.key, rect);
        let startY = y;
        let skipped = 0;
        let width = 0;
        let children = [];
        let rowHeight = this.getEstimatedRowHeight() + this.gap;
        let childNodes = (0, $684db7aaf37fc901$export$1005530eda016c13)(collection.body, collection);
        for (let node of childNodes){
            ...
            if (y > this.requestedRect.maxY) {
                ...
                let lastNode = (0, $684db7aaf37fc901$export$7475b2c64539e4cf)(childNodes);

...
import {Point as $1bbfd9c42d9344e6$export$baf26146a414f24a} from "../virtualizer/Point.js";
...
class $5f92551cd3597eb4$var$WaterfallLayoutInfo extends (0, $dcdbc700dd92e06f$export$7e0eeb9da702a085) {
    copy() {
        let res = super.copy();
...
const $5f92551cd3597eb4$var$DEFAULT_OPTIONS = {
...
class $5f92551cd3597eb4$export$e9f7cda058ba8df8 extends (0, $bcf18cb0a16f75f6$export$c84671f46d6a1ca) {
    shouldInvalidateLayoutOptions(newOptions, oldOptions) {
        return newOptions.maxColumns !== oldOptions.maxColumns || newOptions.dropIndicatorThickness !== oldOptions.dropIndicatorThickness || !(newOptions.minItemSize || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minItemSize).equals(oldOptions.minItemSize || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minItemSize) || !(newOptions.maxItemSize || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.maxItemSize).equals(oldOptions.maxItemSize || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.maxItemSize) || !(newOptions.minSpace || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minSpace).equals(oldOptions.minSpace || $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minSpace) || newOptions.maxHorizontalSpace !== oldOptions.maxHorizontalSpace || newOptions.loaderHeight !== oldOptions.loaderHeight;
    }
    update(invalidationContext) {
        var _collection_getItem;
        let { minItemSize: minItemSize = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minItemSize, maxItemSize: maxItemSize = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.maxItemSize, minSpace: minSpace = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.minSpace, maxHorizontalSpace: maxHorizontalSpace = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.maxSpace, maxColumns: maxColumns = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.maxColumns, dropIndicatorThickness: dropIndicatorThickness = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.dropIndicatorThickness, loaderHeight: loaderHeight = $5f92551cd3597eb4$var$DEFAULT_OPTIONS.loaderHeight } = invalidationContext.layoutOptions || {};
        ...
        let addNode = (key, node)=>{
            ...
            let layoutInfo = new $5f92551cd3597eb4$var$WaterfallLayoutInfo(node.type, key, rect);
        ...
        if ((lastNode === null || lastNode === void 0 ? void 0 : lastNode.type) === 'loader') {
            ...
            let rect = new (0, $546350db2c358941$export$c79fc6492f3af13d)(horizontalSpacing, maxHeight, loaderWidth, loaderHeight);
        ...
        this.contentSize = new (0, $266cbd2785be3a2c$export$cb6da89c6af1a8ec)(this.virtualizer.size.width, maxHeight);
    ...
    getKeyRightOf(key) {
        ...
        let rect = new (0, $546350db2c358941$export$c79fc6492f3af13d)(layoutInfo.rect.maxX, layoutInfo.rect.y, this.virtualizer.visibleRect.maxX - layoutInfo.rect.maxX, layoutInfo.rect.height);
    ...
    getKeyLeftOf(key) {
        let layoutInfo = this.getLayoutInfo(key);
        if (!layoutInfo) return null;
        let rect = new (0, $546350db2c358941$export$c79fc6492f3af13d)(0, layoutInfo.rect.y, layoutInfo.rect.x, layoutInfo.rect.height);
        let layoutInfos = this.getVisibleLayoutInfos(rect);
        let bestKey = null;
        let bestDistance = Infinity;
        for (let candidate of layoutInfos){
    ...
    getDropTargetFromPoint(x, y) {
        ...
        let key = this.virtualizer.keyAtPoint(new (0, $1bbfd9c42d9344e6$export$baf26146a414f24a)(x, y));
        if (key == null) return {
            type: 'root'
        };
    ...
    constructor(...args){
        super(...args), this.contentSize = new (0, $266cbd2785be3a2c$export$cb6da89c6af1a8ec)(), this.layoutInfos = new Map(), this.numColumns = 0, this.dropIndicatorThickness = 2, this.margin = 0;
    }
}


export {$5f92551cd3597eb4$export$e9f7cda058ba8df8 as WaterfallLayout};
//# sourceMappingURL=WaterfallLayout.js.map

var $4f38c929ec2b5900$exports = require("./TableUtils.cjs");
...
$parcel$export(module.exports, "TableColumnLayout", function () { return $fe2d0e9e91841d18$export$7ff77a162970b30e; });
/*
 ...
 */ 
class $fe2d0e9e91841d18$export$7ff77a162970b30e {
    constructor(options){
    ...
    buildColumnWidths(tableWidth, collection, widths) {
        ...
        let columnWidths = (0, $4f38c929ec2b5900$exports.calculateColumnSizes)(tableWidth, collection.columns.map((col)=>({
                ...col.props,
                key: col.key
        ...
        columnWidths.forEach((width, index)=>{
            ...
            this.columnMinWidths.set(key, (0, $4f38c929ec2b5900$exports.getMinWidth)(column.props.minWidth ?? this.getDefaultMinWidth(column), tableWidth));
            this.columnMaxWidths.set(key, (0, $4f38c929ec2b5900$exports.getMaxWidth)(column.props.maxWidth, tableWidth));
        });
...
//# sourceMappingURL=TableColumnLayout.cjs.map

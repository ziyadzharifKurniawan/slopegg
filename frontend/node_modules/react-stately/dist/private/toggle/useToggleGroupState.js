...
import {useMemo as $9wJF3$useMemo} from "react";
...
function $078dfae9a3d03e5d$export$8deac67f4addf270(props) {
    let { selectionMode: selectionMode = 'single', disallowEmptySelection: disallowEmptySelection, isDisabled: isDisabled = false } = props;
    let [selectedKeys, setSelectedKeys] = (0, $2a35a170cf8e413e$export$40bfa8c7b0832715)((0, $9wJF3$useMemo)(()=>props.selectedKeys ? new Set(props.selectedKeys) : undefined, [
        props.selectedKeys
    ]), (0, $9wJF3$useMemo)(()=>props.defaultSelectedKeys ? new Set(props.defaultSelectedKeys) : new Set(), [
...
export {$078dfae9a3d03e5d$export$8deac67f4addf270 as useToggleGroupState};
//# sourceMappingURL=useToggleGroupState.js.map
